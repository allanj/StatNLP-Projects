 ...
 *
 */
public class SemTextFeatureManager extends FeatureManager{
...
//	private FeatureArrayCache _cache;
	...
	public SemTextFeatureManager(GlobalNetworkParam param_g, HybridGrammar g, SemTextDataManager dm) {
		super(param_g);
		this._g = g;
		this._dm = dm;
