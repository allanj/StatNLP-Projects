...
import com.statnlp.sp.SemTextFeatureManager_Discriminative;
...
public class SemTextExperimenter_Discriminative_TMP {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextExperimenter_Discriminative_TMP.class.getCanonicalName());
		
		System.err.println("2318.0310.2015");
		...
		String train_ids = "data/geoquery-2012-08-27/splits/split-880/run-0/fold-0/train-N50";//+args[1];
