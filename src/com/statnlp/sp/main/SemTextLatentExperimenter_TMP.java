...
import com.statnlp.sp.latent.GlobalNetworkParamCollapser;
import com.statnlp.sp.latent.SemTextLatentFeatureManager;
import com.statnlp.sp.latent.SemTextLatentNetworkCompiler;

public class SemTextLatentExperimenter_TMP {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextLatentExperimenter_TMP.class.getCanonicalName());
...
//		SemTextLatentNetworkCompiler._buildLatent = true;
		
//		SemTextLatentFeatureManager._considerENDAsWord = true;
//		SemTextLatentFeatureManager._considerXYAsWords = true;
		...
		String train_ids = "data/geoquery-2012-08-27/splits/split-880/run-0/fold-0/train-N10";
		...
		System.err.println("size="+insts_prior.size());
		System.exit(1);
...
//		insts_test = insts_train;
		...
		GlobalNetworkParamCollapser.collapse(fm.getParam_G());
		
		SemTextLatentFeatureManager._constructLatentSemantics = false;
		SemTextLatentFeatureManager._constructExplicitSemantics = true;
		SemTextLatentNetworkCompiler._numLatent = 1;
//		SemTextLatentNetworkCompiler._buildLatent = true;
		
		{
			System.err.println("==EVALUATION ON THE TEST SET==");
		...
		
		{
			...
			System.err.println("==EVALUATION ON THE TRAINING SET==");
