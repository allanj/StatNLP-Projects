...
public class SemTextLatentExperimenter_Discriminatve_TMP {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextLatentExperimenter_Discriminatve_TMP.class.getCanonicalName());
		...
		for(int k = 0; k<insts_inits.size(); k++){
			train_instances[k+insts_train.size()] = insts_inits.get(k);
