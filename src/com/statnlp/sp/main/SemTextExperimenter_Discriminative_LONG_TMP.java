...
public class SemTextExperimenter_Discriminative_LONG_TMP {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextExperimenter_Discriminative_LONG_TMP.class.getCanonicalName());
		...
		String train_ids = "data/geoquery-2012-08-27/splits/split-880/run-0/fold-0/train-N10";//+args[1];
		String test_ids = "data/geoquery-2012-08-27/splits/split-880/run-0/fold-0/test-N10";
