...
public class SemTextExperimenter_Discriminative_TMP_NEW {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextExperimenter_Discriminative_TMP_NEW.class.getCanonicalName());
		...
		String train_ids = "data/geoquery-2012-08-27/splits/split-880/run-0/fold-0/train-N100";//+args[1];
		...
		FeatureArrayCache cache = new FeatureArrayCache();

		SemTextFeatureManager_Discriminative_NEW fm = new SemTextFeatureManager_Discriminative_NEW(new GlobalNetworkParam(), g, dm, cache);
//		SemTextFeatureManager fm = new SemTextFeatureManager(new GlobalNetworkParam(), g, dm);
		...
		System.err.println("size of cache:"+cache.size());
		System.err.println("#FAs:"+cache.numFAs());
		System.exit(1);
