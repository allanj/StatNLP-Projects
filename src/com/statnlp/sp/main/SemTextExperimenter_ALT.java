...
import com.statnlp.sp.SemTextFeatureManager_ALT;
...
public class SemTextExperimenter_ALT {
	
	public static void main(String args[]) throws IOException, InterruptedException{
		
		System.err.println(SemTextExperimenter_ALT.class.getCanonicalName());
...
//		insts_test = insts_train;
		...
		SemTextFeatureManager_ALT fm = new SemTextFeatureManager_ALT(new GlobalNetworkParam(), g, dm);
