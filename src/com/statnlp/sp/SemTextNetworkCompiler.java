...
//	private long toNode_latent(int bIndex, int eIndex, SemanticForestNode node, int cept){
//		return NetworkIDMapper.toHybridNodeID(new int[]{eIndex, eIndex-bIndex, node.getHIndex()*2, node.getWIndex(), cept});
//	}
//	
//	private long toNode_latent(int bIndex, int eIndex, SemanticForestNode node, int cept, HybridPattern p){
//		return NetworkIDMapper.toHybridNodeID(new int[]{eIndex, eIndex-bIndex, node.getHIndex()*2-1, cept, p.getId()});
//	}
