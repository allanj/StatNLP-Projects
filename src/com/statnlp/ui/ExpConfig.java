...
public class ExpConfig {
	...
	private static ExpConfig resetDefault()
	{
		...
		ec.Memory = "1g";
		ec.Thread = NetworkConfig.NUM_THREADS;
		ec.ThreadString = String.valueOf(NetworkConfig.NUM_THREADS);
		ec.corpusNames = "";
		ec.Iteration = "2000";
		ec.cv = "";
		ec.subfolders = "";
		ec.CACHE_FEATURES_DURING_TRAINING = NetworkConfig.CACHE_FEATURES_DURING_TRAINING;
