...
public class Evaluator_FindOptimalF1FromLog {
	
	public static void main(String args[])throws IOException{
		
//		String filename = "results/ace2005-latest.log";
//		String filename = "results/genia-new.log";
//		String filename = "results/conll2003-withbow.log";
//		String filename = "logs/lin-2005-wordType.log";
//		String filename = "logs/v2.log";
//		String filename = "logs/2003-normalized.log";
//		String filename = "logs/2003-normalized+gazetteer.log";
		String filename = "logs/last-head-2005.log";
//		String filename = "logs/2003-normalized+gazetteer.log";
//		String filename = "logs/lin-2004-full.log";
