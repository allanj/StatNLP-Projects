...
public class Evaluator_CRFPP_BLIOU {
			...
			for(String subfolder : new String[]{"English"}){
				for(String overlap : new String[]{"no_overlap"}){
...

					{
						...
						String test_pred = "experiments/mention/lcrf-bliou/"+IEConfig._type.name()+"/"+folder+"/"+subfolder+"/"+overlap+"/output-dev.data";
					...
					}
					{
						...
						String test_pred = "experiments/mention/lcrf-bliou/"+IEConfig._type.name()+"/"+folder+"/"+subfolder+"/"+overlap+"/output-test.data";
						scan = new Scanner(new File(test_pred));
