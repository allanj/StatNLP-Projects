...
import com.statnlp.ie.linear.IELinearModel_GENIA;
...
public class MentionExtractionExpr_new_GENIA_wordSimple_NEType_c01 {
...
//				for(String c : new String[]{"0.1", "1", "0.01"}){
				for(String c : new String[]{"0.1"}){
					...
					IELinearFeatureManager_GENIA fm = new IELinearFeatureManager_GENIA(param);
					...
					IELinearModel_GENIA model = new IELinearModel_GENIA(fm, manager.getMentionTemplate().getAllTypesExcludingStartAndFinish_arr());
