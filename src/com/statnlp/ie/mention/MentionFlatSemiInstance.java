...
public class MentionFlatSemiInstance extends FlatSemiInstance{
	
	private static final long serialVersionUID = -653025587024238399L;
	
	private MentionTemplate _info;
	
	public MentionFlatSemiInstance(int id, TextSpan span, MentionTemplate info) {
		super(id, span);
		this._info = info;
	}
	
	public MentionFlatSemiInstance removeOutput(){
		...
		return new MentionFlatSemiInstance(-this._instanceId, uspan, this._info);
	}
