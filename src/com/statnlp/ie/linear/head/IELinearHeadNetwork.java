...
public class IELinearHeadNetwork extends TableLookupNetwork{
	...
	public IELinearHeadNetwork(){
		super();
	}
	
	public IELinearHeadNetwork(int networkId, IELinearHeadInstance inst, LocalNetworkParam param){
		super(networkId, inst, param);
	}

	public IELinearHeadNetwork(int networkId, IELinearHeadInstance inst, long[] nodes, int[][][] children, LocalNetworkParam param, int numNodes){
