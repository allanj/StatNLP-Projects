...
public class IELinearNetwork extends TableLookupNetwork{
	...
	public IELinearNetwork(IELinearInstance inst, IELinearFeatureManager fm, EXP_MODE exp_mode) {
		super(inst, fm, exp_mode);
	}
	
	public IELinearNetwork(IELinearInstance inst, IELinearFeatureManager fm, long[] nodes, int[][][] children, int numNodes, EXP_MODE exp_mode) {
