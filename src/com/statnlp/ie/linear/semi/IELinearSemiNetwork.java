...
public class IELinearSemiNetwork extends TableLookupNetwork{

	private int _numNodes;
	
	public IELinearSemiNetwork(IELinearSemiInstance inst, IELinearSemiFeatureManager fm, EXP_MODE exp_mode) {
		super(inst, fm, exp_mode);
	}
	
	public IELinearSemiNetwork(IELinearSemiInstance inst, IELinearSemiFeatureManager fm, long[] nodes, int[][][] children, int numNodes, EXP_MODE exp_mode) {
