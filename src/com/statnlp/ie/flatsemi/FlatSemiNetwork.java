...
public class FlatSemiNetwork extends TableLookupNetwork{

	private int _numNodes;
	
	public FlatSemiNetwork(FlatSemiInstance inst, FlatSemiFeatureManager fm, EXP_MODE exp_mode) {
		super(inst, fm, exp_mode);
	}
	
	public FlatSemiNetwork(FlatSemiInstance inst, FlatSemiFeatureManager fm, long[] nodes, int[][][] children, int numNodes, EXP_MODE exp_mode) {
