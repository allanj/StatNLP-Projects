...
public abstract class FlatSemiZerothInstance extends Instance{
	
	private static final long serialVersionUID = -1879109898850269290L;

	protected TextSpan _span;

	public FlatSemiZerothInstance(int id, TextSpan span) {
		super(id);
		this._span = span;
	}
	...
	public abstract FlatSemiZerothInstance removeOutput();
