...
public class DataReader_CRFPP2Standard_CONLL2003 {
	
	public static void main(String args[])throws IOException{
		
		String filename_template = "data/CONLL2003/data/English/template";
		...
		filename_input = "data/CONLL2003/train.data";
		filename_output = "data/CONLL2003/data/English/mention-standard/FINE_TYPE/train.data";
...
//		filename_input = "data/raw/CONLL2003/dev.data";
		filename_input = "data/CONLL2003/dev.data";
		filename_output = "data/CONLL2003/data/English/mention-standard/FINE_TYPE/dev.data";
//		filename_output = "data/CONLL2003/data/Dutch/mention-standard/FINE_TYPE/dev.data";
...
//		filename_input = "data/raw/CONLL2003/ned.testb";
		filename_input = "data/CONLL2003/test.data";
		filename_output = "data/CONLL2003/data/English/mention-standard/FINE_TYPE/test.data";
//		filename_output = "data/CONLL2003/data/Dutch/mention-standard/FINE_TYPE/test.data";
...
//		String filename_output;
//
//		filename_input = "data/raw/CONLL2003/esp.train";
//		filename_output = "data/CONLL2003/data/Spanish/mention-standard/FINE_TYPE/train.data";
//		
//		scan = new Scanner(new File(filename_input));
//		p = new PrintWriter(new File(filename_output));
//		
...
//		
//
//		filename_input = "data/raw/CONLL2003/esp.testa";
//		filename_output = "data/CONLL2003/data/Spanish/mention-standard/FINE_TYPE/dev.data";
//		
//		scan = new Scanner(new File(filename_input));
//		p = new PrintWriter(new File(filename_output));
//		
...
//		p.close();
//		
//		filename_input = "data/raw/CONLL2003/esp.testb";
//		filename_output = "data/CONLL2003/data/Spanish/mention-standard/FINE_TYPE/test.data";
//		
//		scan = new Scanner(new File(filename_input));
//		p = new PrintWriter(new File(filename_output));
//		
...
//					System.err.println(s);
					...
					words[k] = fields[0];
					words[k] = WordUtil.normalizeDigits(words[k]);
					words[k] = WordUtil.normalizeMonth(words[k]);
					tags[k] = fields[1];
