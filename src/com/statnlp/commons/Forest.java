...
public class Forest implements Serializable{
	...
	//Allan add's this two constructors
	public Forest(HashMap<TreeNode, ArrayList<TreeNode[]>> _map, TreeNode _root){
		this._map = _map;
		this._root  = _root;
	}
	
	public Forest(Forest forest){
		this(forest._map,forest._root);
	}
	...
	public ArrayList<TreeNode> getAllLeaves(){
		Iterator<TreeNode> keys = this._map.keySet().iterator();
		ArrayList<TreeNode> leaves = new ArrayList<TreeNode>();
		while(keys.hasNext()){
			TreeNode node = keys.next();
