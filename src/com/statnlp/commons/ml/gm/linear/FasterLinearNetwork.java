...
public class FasterLinearNetwork extends LinearNetwork{
	
	private static final long serialVersionUID = -1207303047086257934L;
	private int _num_nodes;

	public FasterLinearNetwork(int networkId, LinearInstance inst, LocalNetworkParam param) {
		super(networkId, inst, param);
		throw new RuntimeException("invalid");
	}
	
	public FasterLinearNetwork(int networkId, LinearInstance inst, long[] nodes, int[][][] children, LocalNetworkParam param, int num_nodes) {
