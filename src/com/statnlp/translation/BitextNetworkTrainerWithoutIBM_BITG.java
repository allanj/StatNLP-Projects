...
public class BitextNetworkTrainerWithoutIBM_BITG {
	...
	public static void main(String args[])throws IOException{
		...
		int num_it = 100;//Integer.parseInt(args[0]);
		...
		BitextNetworkTrainerWithoutIBM_BITG trainer = new BitextNetworkTrainerWithoutIBM_BITG();
...
//				System.exit(1);
			...
			ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(new File("param/bitg/no_ibm/"+src+"-"+tgt+"."+it+".len="+BITG_MAX_LEN+".data")));
...
//	private int instanceId = 0;
	...
	public BitextNetworkTrainerWithoutIBM_BITG(){
	}
