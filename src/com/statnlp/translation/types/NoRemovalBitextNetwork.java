...
public class NoRemovalBitextNetwork extends BitextNetwork{

	public NoRemovalBitextNetwork(BitextInstance inst, FeatureManager fm, long[] nodes, int[][][] children, EXP_MODE exp_mode) {
		super(inst, fm, nodes, children, exp_mode);
	}

	public NoRemovalBitextNetwork(BitextInstance inst, FeatureManager fm, EXP_MODE exp_mode) {
