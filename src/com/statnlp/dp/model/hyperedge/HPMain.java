...
//		testingPath = trainingPath;
		...
		Transformer tran = new HPTransformer();
		DependInstance[] trainingInsts = DependencyReader.readInstance(trainingPath, true,trainNumber,entities,tran, false);
		
		DependInstance[] testingInsts = DependencyReader.readInstance(testingPath, false,testNumber,entities,tran, false);
...
//		System.exit(0);
		...
		HPFeatureManager dfm = new HPFeatureManager(new GlobalNetworkParam(),entities);
		HPNetworkCompiler dnc = new HPNetworkCompiler(NetworkConfig.typeMap, viewer);
	...
	public static void processArgs(String[] args){
		String usage = "\t usage: java -jar hpmodel.jar -trainNum -1 -testNum -1 -thread 5 -iter 100 -train path -test path";
