package com.statnlp.dp.model.simple;
...
//		testingPath = trainingPath;
		...
		Transformer tran = new SIMTransformer();
...
//		System.exit(0);
		...
		SIMFeatureManager hpfm = new SIMFeatureManager(new GlobalNetworkParam(),entities);
		SIMNetworkCompiler dnc = new SIMNetworkCompiler(NetworkConfig.typeMap, viewer);
