...
public class NKDFeatureManager extends FeatureManager {
	...
	public NKDFeatureManager(GlobalNetworkParam param_g, String[] types) {
		super(param_g);
		this.types = types;
	}
...
//			if(isEntity(child_1_type) && completeness==0 && !child_1_type.startsWith(PARENT_IS)){
//				
//				
