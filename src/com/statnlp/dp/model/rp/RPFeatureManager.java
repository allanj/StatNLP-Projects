...
public class RPFeatureManager extends FeatureManager {
	...
	public RPFeatureManager(GlobalNetworkParam param_g, String[] types) {
		super(param_g);
		this.types = types;
	}
...
//		int instanceId = di.getInstanceId();
		...
		if(!child_1_type.equals("OE") && type.startsWith("pae")){
			...
			//(pa_type.equals("OE")||pa_type.equals("null")) && 
			...
			if(!child_1_type.equals("OE") && !child_1_type.equals("ONE") && completeness==0){
				...
				featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(), "joint-modifierwordtag", "JOINT:"+child_1_type+":"+modifierWord+","+modifierTag));
