...
//		numThreads = 8;
		...
		Transformer tran = new H2Transformer();
...
//		System.exit(0);
		...
		H2FeatureManager hpfm = new H2FeatureManager(new GlobalNetworkParam(),entities);
		H2NetworkCompiler dnc = new H2NetworkCompiler(NetworkConfig.typeMap, viewer);
