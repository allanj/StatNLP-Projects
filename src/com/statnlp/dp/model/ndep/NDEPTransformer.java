...
public class NDEPTransformer extends Transformer {
	...
	/**
	 * Assign the entity type to single-word span, which contains the direction
	 * @param sent
	 * @return
	 */
	...
	/**
	 * Start to construct the span tree.
	 */
	@Override
	...
	private void constructSpanTree(Tree currentSpan, Tree currentDependency,String[][] leaves){
		...
		if(pa_leftIndex==pa_rightIndex || (!pa_type.equals(OE) && !pa_type.equals(ONE))){
			return;
		}
