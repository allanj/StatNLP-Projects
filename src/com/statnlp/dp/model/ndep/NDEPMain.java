...
//		testingPath = trainingPath;
		...
		Transformer tran = new NDEPTransformer();
		String decodePath = isDev?devPath:testingPath;
		System.err.println("[Info] trainingFile: "+trainingPath);
...
//		System.exit(0);
		...
		NDEPFeatureManager dfm = new NDEPFeatureManager(new GlobalNetworkParam(),entities);
		NDEPNetworkCompiler dnc = new NDEPNetworkCompiler(NetworkConfig.typeMap, viewer);
	...
	public static void processArgs(String[] args){
		String usage = "\t usage: java -jar NoInternalDep.jar -trainNum -1 -testNum -1 -thread 5 -iter 100 -train path -test path";
