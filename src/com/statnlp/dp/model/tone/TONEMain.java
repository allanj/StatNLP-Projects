...
//		testingPath = trainingPath;
		...
		Transformer tran = new TONETransformer();
...
//		System.exit(0);
		...
		TONEFeatureManager hpfm = new TONEFeatureManager(new GlobalNetworkParam(),entities);
		TONENetworkCompiler dnc = new TONENetworkCompiler(NetworkConfig.typeMap, viewer);
