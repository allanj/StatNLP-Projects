...
public class UMMain {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String dpRes = DPConfig.data_prefix+"um.dp.res.txt"; 
		String nerEval = DPConfig.data_prefix+"um.ner.eval.txt"; 
		String jointRes = DPConfig.data_prefix+"um.joint.res.txt";
		String modelType = MODEL.UMMODEL.name();
...
//		testingPath = trainingPath;
		...
		Transformer tran = new UMTransformer();
...
//		System.exit(0);
		...
		UMFeatureManager dfm = new UMFeatureManager(new GlobalNetworkParam(),entities);
		UMNetworkCompiler dnc = new UMNetworkCompiler(NetworkConfig.typeMap,viewer);
