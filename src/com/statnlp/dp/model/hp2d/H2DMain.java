...
//		DPConfig.weightPath = "data/semeval10t1/ecrf2dWeight.txt";
		...
		Transformer tran = new H2DTransformer();
...
//		System.exit(0);
		...
		H2DFeatureManager hpfm = new H2DFeatureManager(new GlobalNetworkParam(),entities);
		H2DNetworkCompiler dnc = new H2DNetworkCompiler(typeMap, viewer);
