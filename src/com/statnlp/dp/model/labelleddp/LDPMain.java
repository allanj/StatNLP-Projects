...
//		testFile = trainingPath;
		...
		LDPInstance[] testingInsts = null;
		if(dataTypeSet.contains(DPConfig.dataType)){
			trainingInsts = LDPReader.readCNN(trainingPath, true, trainNumber, trans);
			testingInsts = LDPReader.readCNN(testFile, false,testNumber,trans);
		}else{
