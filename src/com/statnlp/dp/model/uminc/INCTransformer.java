...
public class INCTransformer extends Transformer {
	...
	public Tree toSpanTree(Tree dependencyRoot, Sentence sentence){
		...
		spanRootLabel.setValue("0,"+(sentence.length()-1)+",1,1,pae:1:1:null");
		spanTreeRoot.setLabel(spanRootLabel);
		Tree spanTreeERoot = new LabeledScoredTreeNode();
		CoreLabel label = new CoreLabel();
		String type = !haveEntities? "ONE":allSame?sentEntities[1]:"OE";
	...
	private void constructSpanTree(Tree currentSpan, Tree currentDependency,String[] sentEntities, Sentence sent){
		...
		//pae:completeness:direction:pa_type
		if(pa_completeness==0){
			if(pa_direction==1){
				...
				if(isMixed){
					...
					else if(pa_type.equals(leftType)) leftType = "ONE";
					else if(pa_type.equals("ONE")) {
						leftType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(pa_leftIndex!=maxSentIndex)
						leftType = "OE"; 
				}
				leftSpanLabel.setValue(pa_leftIndex+","+maxSentIndex+",1,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				...
				if(isMixed){
					...
					else if(pa_type.equals(rightType)) rightType = "ONE";
					else if(pa_type.equals("ONE")) {
						rightType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(maxSentIndex+1!=pa_rightIndex)
						rightType = "OE";
				}
				
				CoreLabel rightSpanLabel = new CoreLabel(); 
				rightSpanLabel.setValue((maxSentIndex+1)+","+pa_rightIndex+",0,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				...
				if(isMixed){
					...
					if(leftType.equals("O")) leftType = "ONE";
						...
						leftType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(pa_leftIndex!=(minIndex-1))
						leftType = "OE";
				}
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+(minIndex-1)+",1,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				leftChildSpan.setLabel(leftSpanLabel);
				...
				if(isMixed){
					...
					if(rightType.equals("O")) rightType = "ONE";
						...
						rightType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(minIndex!=pa_rightIndex){
						rightType = "OE";
					}
				}
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(minIndex+","+pa_rightIndex+",0,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				rightChildSpan.setLabel(rightSpanLabel);
			...
			if(pa_direction==1){
				...
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+lastChildWordIndex+",1,0,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				leftChildSpan.setLabel(leftSpanLabel);
				...
				if(isMixed){
					...
					if(rightType.equals("O")) rightType = "ONE";
						...
						rightType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(lastChildWordIndex!=pa_rightIndex)
						rightType = "OE";
				}
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(lastChildWordIndex+","+pa_rightIndex+",1,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				rightChildSpan.setLabel(rightSpanLabel);
				...
				if(isMixed){
					...
					if(leftType.equals("O")) leftType = "ONE";
						...
						leftType = "ONE";
						//throw new RuntimeException("parent is ONE, but we have entity now");
					}else if(pa_leftIndex!=firstChildWordIndex)
						leftType = "OE";
				}
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+firstChildWordIndex+",0,1,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				leftChildSpan.setLabel(leftSpanLabel);
				...
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(firstChildWordIndex+","+pa_rightIndex+",0,0,pae:"+pa_completeness+":"+pa_direction+":"+pa_type);
				rightChildSpan.setLabel(rightSpanLabel);
