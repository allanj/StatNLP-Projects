...
public class INCFeatureManager extends FeatureManager {
	...
	public INCFeatureManager(GlobalNetworkParam param_g, String[] types) {
		super(param_g);
		this.types = types;
	}
...
//		int instanceId = di.getInstanceId();
		...
		String type = null;
		if(parentArr[4]==5*types.length)
			type = "pae:1:1:null";
		else if(parentArr[4]>types.length-1){
			int val = parentArr[4]/types.length;
			String paeAtt = null;
			switch(val){
			...
			type = "pae:"+paeAtt+":"+types[parentArr[4]%types.length];
		}else{
		...
		String pa_type = type.startsWith("pae")?values[3]:type;
		boolean pa_complete = values[0].equals("1")? true:false;
		int pa_dir = values[1].equals("1")? 1:0;
		...
		boolean child_1_complete = childArr_1[2]==1?true:false;
		int child_1_dir = childArr_1[3]; 
		String child_1_type = null;
		
		if(childArr_1[4]==5*types.length)
			child_1_type = "pae:1:1:null";
		else if(childArr_1[4]>types.length-1){
			int val = childArr_1[4]/types.length;
			String paeAtt = null;
			switch(val){
			case 1:paeAtt="0:0";break;
			case 2:paeAtt="0:1";break;
			...
			child_1_type = "pae:"+paeAtt+":"+types[childArr_1[4]%types.length];
		}else{
		...
		if(!child_1_type.equals("OE") && type.startsWith("pae")){
			...
			if((pa_type.equals("OE")||pa_type.equals("null")) && !child_1_type.equals("OE")){
...
////					System.err.println(FEATYPE.entity.name()+",EWs,"+child_1_type+":"+sb.toString());
////				}
...
//				}
				...
				if(child_1_complete && pa_complete){
...
//				if(completeness==0){
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHW",child_1_type+":"+headWord));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHT",child_1_type+":"+headTag));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHWT",child_1_type+":"+headWord+","+headTag));
//					
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMW",child_1_type+":"+modifierWord));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMT",child_1_type+":"+modifierTag));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMWT",child_1_type+":"+modifierWord+","+modifierTag));
//					
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMW",child_1_type+":"+headWord+","+modifierWord));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMT",child_1_type+":"+headTag+","+modifierTag));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMWT",child_1_type+":"+headWord+","+headTag+","+modifierWord+","+modifierTag));
//					
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHW-dist",child_1_type+":"+headWord+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHT-dist",child_1_type+":"+headTag+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHWT-dist",child_1_type+":"+headWord+","+headTag+":"+attDist));
//					
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMW-dist",child_1_type+":"+modifierWord+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMT-dist",child_1_type+":"+modifierTag+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EMWT-dist",child_1_type+":"+modifierWord+","+modifierTag+":"+attDist));
//					
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMW-dist",child_1_type+":"+headWord+","+modifierWord+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMT-dist",child_1_type+":"+headTag+","+modifierTag+":"+attDist));
//					featureList.add(this._param_g.toFeature(network,FEATYPE.joint.name(),"EHMWT-dist",child_1_type+":"+headWord+","+headTag+","+modifierWord+","+modifierTag+":"+attDist));	
//				}	
//
