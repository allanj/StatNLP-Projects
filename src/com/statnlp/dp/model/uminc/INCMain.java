...
public class INCMain {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		processArgs(args);
		entities = Init.initializeINCModelTypeMap(selectedEntities);
		
		
		String modelType = MODEL.UMINC.name();
...
//		numThreads = 4;
		...
		Transformer tran = new INCTransformer();
...
//		System.exit(0);
		...
		INCFeatureManager dfm = new INCFeatureManager(new GlobalNetworkParam(),entities);
		INCNetworkCompiler dnc = new INCNetworkCompiler(NetworkConfig.typeMap);
	...
	public static void processArgs(String[] args){
		String usage = "\t usage: java -jar umodel.jar -trainNum -1 -testNum -1 -thread 5 -iter 100 -train path -test path";
