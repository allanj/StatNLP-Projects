...
//		testingPath = trainingPath;
		...
		Transformer tran = new TDTransformer();
...
//		System.exit(0);
		...
		dfm = new TDFeatureManager(new GlobalNetworkParam(),entities);
		TDNetworkCompiler dnc = new TDNetworkCompiler(NetworkConfig.typeMap, viewer);
