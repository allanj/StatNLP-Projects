...
public class VarInstance extends DependInstance {
	...
	public VarInstance(int instanceId, double weight, Sentence sentence, ArrayList<UnnamedDependency> dependencies, Tree dependencyRoot, Tree output) {
	...
	public VarInstance duplicate() {
		VarInstance di = new VarInstance(this._instanceId, this._weight,this.sentence);
		if(output==null)
			di.output = null;
