 ...
 *
 */
public class CWSExperimenter_TMP2 {
	
	public static void main(String args[])throws IOException, InterruptedException{
		
		System.err.println(CWSExperimenter_TMP2.class.getCanonicalName());
		
		NetworkConfig.TRAIN_MODE_IS_GENERATIVE = false;
		CWSNetworkConfig.TAG_GRAM = Integer.parseInt(args[0]);
		NetworkConfig._numThreads = Integer.parseInt(args[1]);
		...
		ObjectOutputStream out = new ObjectOutputStream(
				new FileOutputStream("Train="+filename_train+"-Gram="+CWSNetworkConfig.TAG_GRAM+"-Itrs="+numIterations+"-L2="+NetworkConfig.L2_REGULARIZATION_CONSTANT+".model"));
