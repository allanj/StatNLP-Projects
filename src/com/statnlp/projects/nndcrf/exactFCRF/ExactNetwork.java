...
public class ExactNetwork extends TableLookupNetwork{
	...
	public ExactNetwork(int networkId, ExactInstance inst, LocalNetworkParam param){
		super(networkId, inst, param);
	}
	
	public ExactNetwork(int networkId, ExactInstance inst, long[] nodes, int[][][] children, LocalNetworkParam param, int numNodes){
