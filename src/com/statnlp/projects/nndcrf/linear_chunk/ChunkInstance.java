...
public class ChunkInstance extends Instance {
	...
	public ChunkInstance(int instanceId, double weight, Sentence sent) {
	...
	@Override
	public ChunkInstance duplicate() {
		ChunkInstance inst = new ChunkInstance(this._instanceId, this._weight,this.sentence);
		if(entities!=null)
