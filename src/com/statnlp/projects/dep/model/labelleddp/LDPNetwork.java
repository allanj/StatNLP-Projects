...
public class LDPNetwork extends TableLookupNetwork {
	...
	public LDPNetwork(int networkId, LDPInstance inst, LocalNetworkParam param) {
		super(networkId, inst, param);
		// TODO Auto-generated constructor stub
	}

	public LDPNetwork(int networkId, LDPInstance inst, long[] nodes, int[][][] children, LocalNetworkParam param, int numNodes) {
