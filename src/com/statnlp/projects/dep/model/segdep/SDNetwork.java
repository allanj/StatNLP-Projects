...
public class SDNetwork extends TableLookupNetwork {
	...
	public SDNetwork(int networkId, SDInstance inst, LocalNetworkParam param) {
		super(networkId, inst, param);
	}

	public SDNetwork(int networkId, SDInstance inst, long[] nodes, int[][][] children, LocalNetworkParam param, int numNodes) {
