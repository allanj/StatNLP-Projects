...
public class HBDInstance extends DependInstance {

	private boolean invalid;
	private String[][] leavesType;
	private String[] linearPrediction;
	
	
	public HBDInstance(int instanceId, double weight) {
		super(instanceId, weight);
	}
	
	public HBDInstance(int instanceId, double weight, Sentence sent) {
		super(instanceId, weight, sent);
	}

	public HBDInstance(int instanceId, double weight, Sentence sentence, ArrayList<UnnamedDependency> dependencies, Tree dependencyRoot, Tree output) {
	...
	@Override
	public HBDInstance duplicate() {
		HBDInstance di = new HBDInstance(this._instanceId, this._weight,this.sentence);
		if(output==null)
			di.output = null;
		...
		if(linearPrediction==null)
			di.linearPrediction = null;
		else di.linearPrediction = linearPrediction.clone();
...
//		System.err.println(spanRoot.pennString());
	...
	public String[] getLinearPrediction(){
		return this.linearPrediction;
	}
	
	public void setLinearPrediction(String[] linearPrediction){
		this.linearPrediction = linearPrediction;
	}
