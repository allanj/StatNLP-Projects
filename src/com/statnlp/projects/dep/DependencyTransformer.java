...
public class DependencyTransformer extends Transformer {
	...
	public Tree toSpanTree(Tree dependencyRoot, Sentence sentence){
		...
		spanRootLabel.setValue("0,"+(sentence.length()-1)+",1,1");
...
//		System.err.println("Current word Index:"+currentSentIndex);
		if(pa_completeness==0){
			if(pa_direction==1){
				...
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+maxSentIndex+",1,1");
				leftChildSpan.setLabel(leftSpanLabel);
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue((maxSentIndex+1)+","+pa_rightIndex+",0,1");
				...
				Tree leftChildSpan = new LabeledScoredTreeNode();
				Tree rightChildSpan = new LabeledScoredTreeNode();
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+(minIndex-1)+",1,1");
				leftChildSpan.setLabel(leftSpanLabel);
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(minIndex+","+pa_rightIndex+",0,1");
				rightChildSpan.setLabel(rightSpanLabel);
				currentSpan.addChild(leftChildSpan);
				currentSpan.addChild(rightChildSpan);
...
//				System.err.println("lastChildWordIndex:"+lastChildWordIndex);
//				System.err.println("remove for last:"+idsRemove4Last.toString());
//				System.err.println("remove for copy:"+idsRemove4Copy.toString());
				...
				Tree leftChildSpan = new LabeledScoredTreeNode();
				Tree rightChildSpan = new LabeledScoredTreeNode();
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+lastChildWordIndex+",1,0");
				leftChildSpan.setLabel(leftSpanLabel);
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(lastChildWordIndex+","+pa_rightIndex+",1,1");
				rightChildSpan.setLabel(rightSpanLabel);
				currentSpan.addChild(leftChildSpan);
				currentSpan.addChild(rightChildSpan);
				constructSpanTree(leftChildSpan, currentDependency,sentence);
				...
				Tree leftChildSpan = new LabeledScoredTreeNode();
				Tree rightChildSpan = new LabeledScoredTreeNode();
				CoreLabel leftSpanLabel = new CoreLabel(); leftSpanLabel.setValue(pa_leftIndex+","+firstChildWordIndex+",0,1");
				leftChildSpan.setLabel(leftSpanLabel);
				CoreLabel rightSpanLabel = new CoreLabel(); rightSpanLabel.setValue(firstChildWordIndex+","+pa_rightIndex+",0,0");
				rightChildSpan.setLabel(rightSpanLabel);
				currentSpan.addChild(leftChildSpan);
				currentSpan.addChild(rightChildSpan);
				constructSpanTree(leftChildSpan, copyFirstChildWord,sentence);
