...
public class E2DFeatureManager extends FeatureManager {
	...
	public E2DFeatureManager(GlobalNetworkParam param_g, String[] entities, boolean isPipeLine) {
		super(param_g);
	...
	protected FeatureArray extract_helper(Network network, int parent_k, int[] children_k) {
		...
		E2DInstance inst = ((E2DInstance)network.getInstance());
...
//		String currEn = entities[eId].equals("O")?entities[eId]:entities[eId].substring(2);
		...
		featureList.add(this._param_g.toFeature(network,FEATYPE.local.name(), "ELT-dir",	currEn+":"+lt+":"+att));
		featureList.add(this._param_g.toFeature(network,FEATYPE.local.name(), "ERW-dir",	currEn+":"+rw+":"+att));
		featureList.add(this._param_g.toFeature(network,FEATYPE.local.name(), "ERT-dir",	currEn+":"+rt+":"+att));
		featureList.add(this._param_g.toFeature(network,FEATYPE.local.name(), "ELT-T-dir",	currEn+":"+lt+","+currTag+":"+att));
